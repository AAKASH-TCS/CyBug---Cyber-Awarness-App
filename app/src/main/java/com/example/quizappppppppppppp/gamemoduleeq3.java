...
public class gamemoduleeq3 extends AppCompatActivity {
   ...
   ImageButton m2;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.gamemoduleq3);

        m1=findViewById(R.id.hello);
        m1.setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent l=new Intent(gamemoduleeq3.this,gamemodulew3.class);
                startActivity(l);
                finish();
            }
        });
        ...
        m2.setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent p=new Intent(gamemoduleeq3.this,gamemoduler3.class);
                startActivity(p);
                finish();
            }
        });
